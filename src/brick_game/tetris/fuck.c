...
void move_left_fuck(Area* area, Figure* figure) {
  int code = can_move_left_fuck(area, figure);
  ...
  if (code == 0) {
    ...
    clean_old_fuck_left(area, figure);
  }
}
...
void move_right_fuck(Area* area, Figure* figure) {
  int code = can_move_right_fuck(area, figure);
  ...
  if (code == 0) {
    ...
    change_area(area, figure);
    clean_old_fuck_right(area, figure);
  }
}
...
void move_down_fuck(Area* area, Figure* figure) {
  int code = can_move_down_fuck(area, figure);
  ...
  if (code == 0) {
    ...
    change_area(area, figure);
    clean_old_fuck_down(area, figure);
  }
}
